...
See a more complete [sample](https://github.com/pgagroal/pgagroal/blob/2.0.2/doc/etc/pgagroal.conf) configuration for running [**pgagroal**](https://github.com/pgagroal/pgagroal) on `localhost`.
